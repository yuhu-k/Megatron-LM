...
def _add_training_args(parser):
    ...
    group.add_argument('--finetune-method',choices=["lora", "qlora", "rtn-lora", "fp8-e4m3-lora", "fp8-e5m2-lora", "saliency-lora","all"],
                        help="Only support the following fine-tuning methods: 'lora', 'qlora', 'rtn-lora' or 'all'",
